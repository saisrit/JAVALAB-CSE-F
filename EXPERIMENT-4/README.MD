4a) A JAVA program to implement Single Inheritance
```java
public class Person
 {
 String name; int age;
...
4b)A JAVA program to implement multi-level Inheritance
```java
...
4c)Construct abstract class in JAVA to find areas of different shapes
```java
